...
from Domain.Entities import VideoMetadata, StorageBucket
from Domain.ValueObjects import duration as Duration, resolution as Resolution, title as Title, description as Description


class VideoMetadataAggregate:
    """
    Represents the domain model for Video Metadata, including its associated storage buckets,
    duration, resolution, title, and description.
    """
    def __init__(
        self,
        uuid: UUID,
    ...
    def update_entity(self, entity: VideoMetadata):
        ...
        entity.title = str(self.title)  # Convert Title VO to string
        entity.description = str(self.description)  # Convert Description VO to string
    ...
    def reconstitute(
        ...
        return VideoMetadataAggregate(
            uuid=entity.uuid,
            title=Title(entity.title),  # Wrap string in Title VO
            description=Description(entity.description),  # Wrap string in Description VO
